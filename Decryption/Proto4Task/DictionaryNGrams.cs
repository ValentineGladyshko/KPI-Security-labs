...
namespace Decryption.Proto4Task
{
    class DictionaryNGrams
    {
        ...
        {
            Dictionary = File.ReadLines("../../../Decryption/Proto4Task/DictionaryNGrams.txt")
                .Select(line => line.Split(' '))
                .ToDictionary(line => line[0].ToLower(), line => Convert.ToDouble(line[1]));
        }
        private void CreateDictionary()
        {
            Dictionary<string, int> words = File.ReadLines("../../../Decryption/Proto4Task/WordsFrequency.txt")
               .Select(line => line.Split(' '))
            ...
            using (StreamWriter sw = new StreamWriter("../../../Decryption/Proto4Task/DictionaryNGrams.txt"))
            {
